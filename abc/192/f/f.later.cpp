// 本番のACコードから以下を変更
//   - 到達不可能な状態は-1を表すようdpの定義を変更し、dpテーブルの数を1個にする
...
int main(void)
{
    ...
    FOR(i, 1, N + 1)
    {
        ...
        else
        {
            ...
            // dp[位置][使ったポーション数][mod]
            // 到達不可能な場合は-1を入れておくと約束
            auto dp = make_v<ll>(N + 1, i + 1, i);
            fill_v(dp, -1);
