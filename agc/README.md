...
| 009 F |  | | |
| 010 A |○| | |
| 010 B |△|★石が円環状に並ぶ。階段状に石を取り除く操作を繰り返して石を取りきれるか判定|隣り合う石同士の個数の増減に着目|
| 010 C |  | | |
| 010 D |  | | |
| 010 E |  | | |
| 010 F |  | | |
...
| 029 F |  | | |
| 030 A | ◎ | | |
| 030 B | ○/× |時計回りまたは反時計回りで木を燃やす。最長距離を答える|SmallはDP|
| 030 C |  | | |
| 030 D |  | | |
| 030 E |  | | |
| 030 F |  | | |
| 031 A |◎| | |
| 031 B |◎| | |
| 031 C |○|AからBまでNビットの数をすべて経由して辿るパスを構築|次元を減らすようにパス構築|
| 031 D |  | | |
| 031 E |  | | |
| 031 F |  | | |
| 033 A |◎| | |
| 033 B |◎|コマを盤面から落とせるか落とせないか判定|★嘘解法で通ってしまった。要復習|
| 033 C |◎|木からコインを取っていくゲームの勝者を当てる|木の直径に着目|
| 033 D |  | | |
| 033 E |  | | |
| 033 F |  | | |
| 043 A |□|左上から右下まで全部白にするために矩形領域を何回反転させるか|★白から黒に変わる数を数えるDP|
| 043 B |×|1,2,3からなる数列の差をとっていき最後の数を求める|★mod 2に着目すると差と和が同じになる|
| 043 C |  | | |
| 043 D |  | | |
| 043 E |  | | |
| 043 F |  | | |
...
| A |△|xorで0に近づけるプレイヤーと1に近づけるプレイヤーのどちらが勝つか判定|★F_2での基底を考える|
| B |  | | |
| C |  | | |
| D |  | | |
| E |  | | |
